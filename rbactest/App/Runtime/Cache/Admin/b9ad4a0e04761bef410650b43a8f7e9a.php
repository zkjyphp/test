...
<head>
    ...
    <style>
        ...
        #search form input.text-but {
            ...
            line-height: 24px;
            width: 55px;
            background: url(http://localhost/rbactest/Public/Admin/Images/main/list_input.jpg) no-repeat left top;
            border: none;
            cursor: pointer;
        ...
        #search a.add {
            background: url(http://localhost/rbactest/Public/Admin/Images/main/add.jpg) no-repeat -3px 7px #548fc9;
        ...
        #main-tab th {
            font-size: 12px;
            background: url(http://localhost/rbactest/Public/Admin/Images/main/list_bg.jpg) repeat-x;
            height: 32px;
            line-height: 32px;
        }
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    ...
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a
                            href="add.html" target="mainFrame" onFocus="this.blur()" class="add">新增管理员</a></td>
                </tr>
            </table>
        </td>
    </tr>
...
<?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr onMouseOut="this.style.backgroundColor='#ffffff'"
                            ...
                            <?php if(($vo["mg_role_id"]) == "0"): ?><td align="center" valign="middle" class="borderbottom">
                                    <a href="" target="mainFrame" onFocus="this.blur()" class="add">更改密码</a>
                                </td>
                                <?php else: ?>
                                <td align="center" valign="middle" class="borderbottom">
                                    <a href="<?php echo U('edit');?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
                ...
                <tr>
                    <td align="left" valign="top" class="fenye">11 条数据 1/1 页&nbsp;&nbsp;<a href="#" target="mainFrame"
                            ...
                            href="#" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;<a href="#"
                                                                                                    target="mainFrame"
